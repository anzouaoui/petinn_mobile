...
class OnbaordingPageWidget extends StatefulWidget {
  ...
  static String routeName = 'OnbaordingPage';
  static String routePath = '/onbaordingPage';
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'za14kvlv' /* Easily find accommodations tha... */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'tw1n1yvs' /* Travel with Peace of Mind */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .displaySmall
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'jv6anxic' /* Book in just a few taps and en... */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'qvxfvpj4' /* A Passionate Community */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .displaySmall
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                '87vv314a' /* Read reviews, share your exper... */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
